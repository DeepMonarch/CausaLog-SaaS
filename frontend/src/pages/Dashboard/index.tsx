...
export default function DashboardPage() {
  ...
  const handleFile = async (file: File) => {
    ...
    try {
      ...
      setState('done')
      // Navigate to analysis page after brief pause
    ...
    <div className="p-8 max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="mb-8">
        ...
        <p className="text-text-secondary text-sm mt-1">
          Upload a log file to start diagnosing issues.
        </p>
      </div>
      ...
      <div
        ...
        `}
        style={{ minHeight: 280, background: '#0f1526' }}
      >
        <input
          ref={fileInputRef}
          type="file"
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-3 mt-2">
              {['Upload', 'Preprocess', 'ML Pipeline', 'Inference', 'Report'].map((step, i) => {
                ...
                const active = (state === 'uploading' && i === 0) || (state === 'analyzing' && i > 0 && i < 3)
                return (
